// Field definitions for CWR record types validated but not emitted by a writer (AGR/TER/IPA/COM/EWT/VER/PER/
...
// appear in ASCII registration files. They need separate parser and grammar support.
